...
<body>
	...
	<div id="editcasePageId" class="easyui-dialog" modal=true closed=true  buttons="#editcasePageButton" style="width:500px;height:660px" >
		<form id="editcasePageFromId" style="padding:30px;">
			<label>接口序号</label>
 			...
 			<label>请求方式</label>
		   	...
		   	<label>请求参数</label><br>
		   	<textarea style="width:420px;height:50px" id="interfaceParameter" name="interfaceParameter"/><br><br><br>
		   	<label>参数格式</label>
			...
			<div id="dependId_edit" style="display:none;">
				<label>依赖关系</label>
			   	<input id="depend" name="depend"/><br><br><br>
