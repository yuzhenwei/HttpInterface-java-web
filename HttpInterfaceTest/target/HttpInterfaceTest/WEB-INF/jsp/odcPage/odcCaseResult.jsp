...
<body>
	...
	<div style="padding:5px;" class="easyui-panel">
		<div style="padding:5px;">
			<select id="selectNameId_odc" class="easyui-combobox" name="dept" style="width:130px;" panelHeight=100>    
			    <option value="interfaceName">接口名称</option>   
			    <option value="authStatus">执行结果</option> 
			</select> 
			<input type="text" id="inputText_odc" name="inputText" /> 
			<a class="easyui-linkbutton" iconCls="icon-search" onClick="searchRunCaseResultInterface_odc()">查询</a>
		</div>		
			...
			url="case/searchRunCaseResult.action?region=ODC" fitColumns=true nowrap=false toolbar="#deleteCaseListResultId_odc"
			>
		        <thead>
		            <tr>
		    ...
		    <div id="deleteCaseListResultId_odc" style="padding:5px;">
				<a class="easyui-linkbutton" iconCls="icon-cancel" onClick="deleteCaseListResult_odc()">删除执行结果</a>
		    </div>	
