...
<head>
	...
	<script type="text/javascript"  src="js/report/reportJs.js"></script>	
...
<body>
	...
	<div style="padding:5px;" class="easyui-panel" fit=true >
		...
		<div style="font-size:16px">
			用例总个数:<a id="sumNub"></a>数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			失败个数:<a id="failNub"></a>数&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			通过个数:<a id="psNub"></a>数&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			执行时间:<a id="runTime"></a>s		
		</div>	
		<table id="runCaseListDlgTab_sku" class="easyui-datagrid"  title="执行结果集列表" 
			...
			url="case/searchRunCaseResult.action?region=SKU" fitColumns=true nowrap=false>
		        <thead>
		            <tr>
						...
						<th field="authStatus"  width=110px formatter="frAuthStats"align="center" >执行结果</th>
						<th field="reason"  width=110px align="left">原因</th>
						<th field="runTime" width=110px formatter="runTimeSum" align="center">执行时间</th>													             
		            </tr>
		        </thead>
		    </table>	
