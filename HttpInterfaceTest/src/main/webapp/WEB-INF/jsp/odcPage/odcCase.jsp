...
<body>
	...
	<div style="padding:5px;" class="easyui-panel" fit=true >
	    ...
	    <div id="caseListTb1" style="padding:5px;">
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-undo"  onClick="batchOutCase_ODC()">批量导出</a>&nbsp;	        
					
		</div>
		<!-- 注释 -->
		<div id="edListTb1" style="padding:5px;">
			<label>测试地址</label>
			<input id="testLocationIp_odc" class="easyui-combobox"  valueField="address" textField="locationName" url="location/searchLocation.action?region=ODC" /> 
			&nbsp;
